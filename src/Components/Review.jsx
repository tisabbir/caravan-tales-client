  ...
  return (
    <div className="width-fixer mt-12">
      ...
      <div className="flex flex-col md:flex-row lg:flex-row justify-around">
        <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-100 text-gray-900">
          <div className="flex flex-col items-center w-full">
            ...
            <div className="flex flex-col w-full">
              <textarea
                rows="3"
                placeholder="Message..."
                className="p-4 rounded-md resize-none text-gray-900 bg-gray-300"
              ></textarea>
              <button
                type="button"
