...
const AllListSpot = ({spot}) => {
    ...
    return (
        <div>
           ...
           <Link to={`/alldetails/${_id}`} className="btn bg-green-400 w-full text-white animate__animated animate__pulse animate__infinite	 ">View Details</Link>
