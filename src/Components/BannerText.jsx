...
const BannerText = () => {
    ...
    <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold">Explore Central Asia</h1>

    <h1 className="text-xl md:text-2xl lg:text-4xl font-bold"> Your Adventure Awaits</h1>
